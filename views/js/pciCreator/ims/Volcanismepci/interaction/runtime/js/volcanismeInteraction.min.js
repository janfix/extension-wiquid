...
},type,chainable?margin:void 0,chainable,null)}})}),jQuery.fn.size=function(){return this.length},jQuery.fn.andSelf=jQuery.fn.addBack;var _jQuery=window.jQuery,_$=window.$;return jQuery.noConflict=function(deep){return window.$===jQuery&&(window.$=_$),deep&&window.jQuery===jQuery&&(window.jQuery=_jQuery),jQuery},void 0===noGlobal&&(window.jQuery=window.$=jQuery),jQuery}),jQuery.noConflict(!0)}),function(e,r){"object"==typeof exports&&"object"==typeof module?module.exports=r():"function"==typeof define&&define.amd?define("volcanismePCI/interaction/runtime/js/lib/raphael.min",[],r):"object"==typeof exports?exports.Raphael=r():e.Raphael=r()}(this,function(){
return function(t){function e(i){if(r[i])return r[i].exports;var n=r[i]={exports:{},id:i,loaded:!1};return t[i].call(n.exports,n,n.exports,e),n.loaded=!0,n.exports}var r={};return e.m=t,e.c=r,e.p="",e(0)}([function(t,e,r){var i,n;i=[r(1),r(3),r(4)],void 0!==(n=function(t){return t}.apply(e,i))&&(t.exports=n)},function(t,e,r){var i,n;i=[r(2)],void 0!==(n=function(t){function e(r){if(e.is(r,"function"))return w?r():t.on("raphael.DOMload",r);if(e.is(r,Q))return e._engine.create[z](e,r.splice(0,3+e.is(r[0],$))).add(r);var i=Array.prototype.slice.call(arguments,0);if(e.is(i[i.length-1],"function")){var n=i.pop()
;return w?n.call(e._engine.create[z](e,i)):t.on("raphael.DOMload",function(){n.call(e._engine.create[z](e,i))})}return e._engine.create[z](e,arguments)}function r(t){if("function"==typeof t||Object(t)!==t)return t;var e=new t.constructor;for(var i in t)t[T](i)&&(e[i]=r(t[i]));return e}function i(t,e){for(var r=0,i=t.length;i>r;r++)if(t[r]===e)return t.push(t.splice(r,1)[0])}function n(t,e,r){function n(){var a=Array.prototype.slice.call(arguments,0),s=a.join("␀"),o=n.cache=n.cache||{},l=n.count=n.count||[];return o[T](s)?(i(l,s),r?r(o[s]):o[s]):(l.length>=1e3&&delete o[l.shift()],l.push(s),o[s]=t[z](e,a),r?r(o[s]):o[s])}return n}function a(){return this.hex}
function s(t,e){for(var r=[],i=0,n=t.length;n-2*!e>i;i+=2){var a=[{x:+t[i-2],y:+t[i-1]},{x:+t[i],y:+t[i+1]},{x:+t[i+2],y:+t[i+3]},{x:+t[i+4],y:+t[i+5]}];e?i?n-4==i?a[3]={x:+t[0],y:+t[1]}:n-2==i&&(a[2]={x:+t[0],y:+t[1]},a[3]={x:+t[2],y:+t[3]}):a[0]={x:+t[n-2],y:+t[n-1]}:n-4==i?a[3]=a[2]:i||(a[0]={x:+t[i],y:+t[i+1]}),r.push(["C",(-a[0].x+6*a[1].x+a[2].x)/6,(-a[0].y+6*a[1].y+a[2].y)/6,(a[1].x+6*a[2].x-a[3].x)/6,(a[1].y+6*a[2].y-a[3].y)/6,a[2].x,a[2].y])}return r}function o(t,e,r,i,n){return t*(t*(-3*e+9*r-9*i+3*n)+6*e-12*r+6*i)-3*e+3*r}function l(t,e,r,i,n,a,s,l,h){null==h&&(h=1),h=h>1?1:0>h?0:h
;for(var u=h/2,f=[-.1252,.1252,-.3678,.3678,-.5873,.5873,-.7699,.7699,-.9041,.9041,-.9816,.9816],p=[.2491,.2491,.2335,.2335,.2032,.2032,.1601,.1601,.1069,.1069,.0472,.0472],d=0,g=0;12>g;g++){var x=u*f[g]+u,v=o(x,t,r,n,s),y=o(x,e,i,a,l),m=v*v+y*y;d+=p[g]*Y.sqrt(m)}return u*d}function h(t,e,r,i,n,a,s,o,h){if(!(0>h||l(t,e,r,i,n,a,s,o)<h)){var p,c=.5,f=1-c;for(p=l(t,e,r,i,n,a,s,o,f);H(p-h)>.01;)c/=2,f+=(h>p?1:-1)*c,p=l(t,e,r,i,n,a,s,o,f);return f}}function u(t,e,r,i,n,a,s,o){if(!(W(t,r)<G(n,s)||G(t,r)>W(n,s)||W(e,i)<G(a,o)||G(e,i)>W(a,o))){var l=(t*i-e*r)*(n-s)-(t-r)*(n*o-a*s),h=(t*i-e*r)*(a-o)-(e-i)*(n*o-a*s),u=(t-r)*(a-o)-(e-i)*(n-s);if(u){
var c=l/u,f=h/u,p=+c.toFixed(2),d=+f.toFixed(2);if(!(p<+G(t,r).toFixed(2)||p>+W(t,r).toFixed(2)||p<+G(n,s).toFixed(2)||p>+W(n,s).toFixed(2)||d<+G(e,i).toFixed(2)||d>+W(e,i).toFixed(2)||d<+G(a,o).toFixed(2)||d>+W(a,o).toFixed(2)))return{x:c,y:f}}}}function p(t,r,i){var n=e.bezierBBox(t),a=e.bezierBBox(r);if(!e.isBBoxIntersect(n,a))return i?0:[];for(var s=l.apply(0,t),o=l.apply(0,r),h=W(~~(s/5),1),c=W(~~(o/5),1),f=[],p=[],d={},g=i?0:[],x=0;h+1>x;x++){var v=e.findDotsAtSegment.apply(e,t.concat(x/h));f.push({x:v.x,y:v.y,t:x/h})}for(x=0;c+1>x;x++)v=e.findDotsAtSegment.apply(e,r.concat(x/c)),p.push({x:v.x,y:v.y,t:x/c});for(x=0;h>x;x++)for(var y=0;c>y;y++){
var m=f[x],b=f[x+1],_=p[y],w=p[y+1],k=H(b.x-m.x)<.001?"y":"x",B=H(w.x-_.x)<.001?"y":"x",C=u(m.x,m.y,b.x,b.y,_.x,_.y,w.x,w.y);if(C){if(d[C.x.toFixed(4)]==C.y.toFixed(4))continue;d[C.x.toFixed(4)]=C.y.toFixed(4);var S=m.t+H((C[k]-m[k])/(b[k]-m[k]))*(b.t-m.t),T=_.t+H((C[B]-_[B])/(w[B]-_[B]))*(w.t-_.t);S>=0&&1.001>=S&&T>=0&&1.001>=T&&(i?g++:g.push({x:C.x,y:C.y,t1:G(S,1),t2:G(T,1)}))}}return g}function d(t,r,i){t=e._path2curve(t),r=e._path2curve(r);for(var n,a,s,o,l,h,u,c,f,d,g=i?0:[],x=0,v=t.length;v>x;x++){var y=t[x];if("M"==y[0])n=l=y[1],a=h=y[2];else{"C"==y[0]?(f=[n,a].concat(y.slice(1)),n=f[6],a=f[7]):(f=[n,a,n,a,l,h,l,h],n=l,a=h)
;for(var m=0,b=r.length;b>m;m++){var _=r[m];if("M"==_[0])s=u=_[1],o=c=_[2];else{"C"==_[0]?(d=[s,o].concat(_.slice(1)),s=d[6],o=d[7]):(d=[s,o,s,o,u,c,u,c],s=u,o=c);var w=p(f,d,i);if(i)g+=w;else{for(var k=0,B=w.length;B>k;k++)w[k].segment1=x,w[k].segment2=m,w[k].bez1=f,w[k].bez2=d;g=g.concat(w)}}}}}return g}function g(t,e,r,i,n,a){null!=t?(this.a=+t,this.b=+e,this.c=+r,this.d=+i,this.e=+n,this.f=+a):(this.a=1,this.b=0,this.c=0,this.d=1,this.e=0,this.f=0)}function v(){return this.x+I+this.y+I+this.width+" × "+this.height}function y(t,e,r,i,n,a){function s(t){return((c*t+u)*t+h)*t}function l(t,e){var r,i,n,a,o,l;for(n=t,l=0;8>l;l++){if(a=s(n)-t,H(a)<e)return n
;if(o=(3*c*n+2*u)*n+h,H(o)<1e-6)break;n-=a/o}if(r=0,i=1,n=t,r>n)return r;if(n>i)return i;for(;i>r;){if(a=s(n),H(a-t)<e)return n;t>a?r=n:i=n,n=(i-r)/2+r}return n}var h=3*e,u=3*(i-e)-h,c=1-h-u,f=3*r,p=3*(n-r)-f,d=1-f-p;return function(t,e){var r=l(t,e);return((d*r+p)*r+f)*r}(t,1/(200*a))}function m(t,e){var r=[],i={};if(this.ms=e,this.times=1,t){for(var n in t)t[T](n)&&(i[ht(n)]=t[n],r.push(ht(n)));r.sort(Bt)}this.anim=i,this.top=r[r.length-1],this.percents=r}function b(r,i,n,a,s,o){n=ht(n);var l,h,u,f,p,d,x=r.ms,v={},m={},b={};if(a)for(w=0,B=Ee.length;B>w;w++){var _=Ee[w];if(_.el.id==i.id&&_.anim==r){_.percent!=n?(Ee.splice(w,1),u=1):h=_,i.attr(_.totalOrigin)
;break}}else a=+m;for(var w=0,B=r.percents.length;B>w;w++){if(r.percents[w]==n||r.percents[w]>a*r.top){n=r.percents[w],p=r.percents[w-1]||0,x=x/r.top*(n-p),f=r.percents[w+1],l=r.anim[n];break}a&&i.attr(r.anim[r.percents[w]])}if(l){if(h)h.initstatus=a,h.start=new Date-h.ms*a;else{for(var C in l)if(l[T](C)&&(pt[T](C)||i.paper.customAttributes[T](C)))switch(v[C]=i.attr(C),null==v[C]&&(v[C]=ft[C]),m[C]=l[C],pt[C]){case $:b[C]=(m[C]-v[C])/x;break;case"colour":v[C]=e.getRGB(v[C]);var S=e.getRGB(m[C]);b[C]={r:(S.r-v[C].r)/x,g:(S.g-v[C].g)/x,b:(S.b-v[C].b)/x};break;case"path":var A=Qt(v[C],m[C]),E=A[1];for(v[C]=A[0],b[C]=[],w=0,B=v[C].length;B>w;w++){b[C][w]=[0]
;for(var M=1,N=v[C][w].length;N>M;M++)b[C][w][M]=(E[w][M]-v[C][w][M])/x}break;case"transform":var L=i._,z=le(L[C],m[C]);if(z)for(v[C]=z.from,m[C]=z.to,b[C]=[],b[C].real=!0,w=0,B=v[C].length;B>w;w++)for(b[C][w]=[v[C][w][0]],M=1,N=v[C][w].length;N>M;M++)b[C][w][M]=(m[C][w][M]-v[C][w][M])/x;else{var F=i.matrix||new g,R={_:{transform:L.transform},getBBox:function(){return i.getBBox(1)}};v[C]=[F.a,F.b,F.c,F.d,F.e,F.f],se(R,m[C]),m[C]=R._.transform,b[C]=[(R.matrix.a-F.a)/x,(R.matrix.b-F.b)/x,(R.matrix.c-F.c)/x,(R.matrix.d-F.d)/x,(R.matrix.e-F.e)/x,(R.matrix.f-F.f)/x]}break;case"csv":var I=j(l[C])[q](k),D=j(v[C])[q](k);if("clip-rect"==C)for(v[C]=D,b[C]=[],
w=D.length;w--;)b[C][w]=(I[w]-v[C][w])/x;m[C]=I;break;default:for(I=[][P](l[C]),D=[][P](v[C]),b[C]=[],w=i.paper.customAttributes[C].length;w--;)b[C][w]=((I[w]||0)-(D[w]||0))/x}var V=l.easing,O=e.easing_formulas[V];if(!O)if((O=j(V).match(st))&&5==O.length){var Y=O;O=function(t){return y(t,+Y[1],+Y[2],+Y[3],+Y[4],x)}}else O=St;if(d=l.start||r.start||+new Date,_={anim:r,percent:n,timestamp:d,start:d+(r.del||0),status:0,initstatus:a||0,stop:!1,ms:x,easing:O,from:v,diff:b,to:m,el:i,callback:l.callback,prev:p,next:f,repeat:o||r.times,origin:i.attr(),totalOrigin:s},Ee.push(_),a&&!h&&!u&&(_.stop=!0,_.start=new Date-x*a,1==Ee.length))return Ne()
;u&&(_.start=new Date-_.ms*a),1==Ee.length&&Me(Ne)}t("raphael.anim.start."+i.id,i,r)}}function _(t){for(var e=0;e<Ee.length;e++)Ee[e].el.paper==t&&Ee.splice(e--,1)}e.version="2.2.0",e.eve=t;var w,N,k=/[, ]+/,B={circle:1,rect:1,path:1,ellipse:1,text:1,image:1},C=/\{(\d+)\}/g,T="hasOwnProperty",A={doc:document,win:window},E={was:Object.prototype[T].call(A.win,"Raphael"),is:A.win.Raphael},M=function(){this.ca=this.customAttributes={}
},z="apply",P="concat",F="ontouchstart"in A.win||A.win.DocumentTouch&&A.doc instanceof DocumentTouch,R="",I=" ",j=String,q="split",D="click dblclick mousedown mousemove mouseout mouseover mouseup touchstart touchmove touchend touchcancel"[q](I),V={mousedown:"touchstart",mousemove:"touchmove",mouseup:"touchend"},O=j.prototype.toLowerCase,Y=Math,W=Y.max,G=Y.min,H=Y.abs,X=Y.pow,U=Y.PI,$="number",Z="string",Q="array",tt=Object.prototype.toString,nt=(e._ISURL=/^url\(['"]?(.+?)['"]?\)$/i,
/^\s*((#[a-f\d]{6})|(#[a-f\d]{3})|rgba?\(\s*([\d\.]+%?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+%?)?)\s*\)|hsba?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\)|hsla?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\))\s*$/i),at={NaN:1,Infinity:1,"-Infinity":1},st=/^(?:cubic-)?bezier\(([^,]+),([^,]+),([^,]+),([^\)]+)\)/,ot=Y.round,ht=parseFloat,ut=parseInt,ct=j.prototype.toUpperCase,ft=e._availableAttrs={"arrow-end":"none","arrow-start":"none",blur:0,"clip-rect":"0 0 1e9 1e9",cursor:"default",cx:0,cy:0,fill:"#fff","fill-opacity":1,font:'10px "Arial"',"font-family":'"Arial"',
"font-size":"10","font-style":"normal","font-weight":400,gradient:0,height:0,href:"http://raphaeljs.com/","letter-spacing":0,opacity:1,path:"M0,0",r:0,rx:0,ry:0,src:"",stroke:"#000","stroke-dasharray":"","stroke-linecap":"butt","stroke-linejoin":"butt","stroke-miterlimit":0,"stroke-opacity":1,"stroke-width":1,target:"_blank","text-anchor":"middle",title:"Raphael",transform:"",width:0,x:0,y:0,class:""},pt=e._availableAnimAttrs={blur:$,"clip-rect":"csv",cx:$,cy:$,fill:"colour","fill-opacity":$,"font-size":$,height:$,opacity:$,path:"path",r:$,rx:$,ry:$,stroke:"colour","stroke-opacity":$,"stroke-width":$,transform:"transform",width:$,x:$,y:$
},gt=/[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*/,xt={hs:1,rg:1
...
r[t].apply(r,e)})}}(z))}}.apply(e,i))&&(t.exports=n)}])}),define("css!volcanismePCI/interaction/runtime/css/volcanisme",[],function(){}),define("volcanismePCI/interaction/runtime/js/renderer",["taoQtiItem/portableLib/jquery_2_1_1","volcanismePCI/interaction/runtime/js/lib/raphael.min","lodash","css!volcanismePCI/interaction/runtime/css/volcanisme"],function($,Raphael,_){"use strict";function renderChoices(id,$container,config){function dropcachet(){splizz=paper.ellipse(245,0,20,20).attr({fill:"lightgrey",stroke:"none"}),splizz.animate({cx:245,cy:410,r:20},1e3,function(){splizz.animate({cx:250,cy:429,rx:17,ry:10},350,function(){this.animate({cx:310,cy:450,
ry:3,transform:"r-30"},2e3,function(){this.animate({transform:"r0",cy:460},1e3,function(){createbulles(30),boucheur()})})})})}function getRandomArbitrary(min,max){return Math.random()*(max-min)+min}function createbulles(quanti){var start;for(start=1;start<10;start++)bulletimer=setTimeout(function(){var i,cx,cy;for(i=0;i<quanti;i++)cx=getRandomArbitrary(290,330),cy=getRandomArbitrary(450,460),bullor=paper.ellipse(cx,cy,5,5).attr({id:"path4166-2-04",parent:"layer1",opacity:"0",fill:"white","fill-opacity":"0.5",stroke:"#white","stroke-width":"0.31","stroke-linecap":"round","stroke-linejoin":"round","stroke-miterlimit":"4","stroke-dasharray":"none",
"stroke-opacity":"1"}),bullor.animate({opacity:1},1e3),bullecollector.push(bullor),i<quanti/2?setleftbull.push(bullor):setrightbull.push(bullor);bullemonte(setleftbull),bullemonte(setrightbull)},1e3*start);return buttontimer=setTimeout(function(){btzeroset.forEach(function(e){e.show()})},20500),arraytimer=[buttontimer,bulletimer]}function bullemonte(setname){setname==setleftbull?(setname.forEach(function(el){var posirx=getRandomArbitrary(215,280),posiry=getRandomArbitrary(390,450);el.animate({cx:posirx,cy:posiry},1e3,function(){posirx=getRandomArbitrary(220,265),posiry=getRandomArbitrary(200,230),el.animate({cx:posirx,cy:posiry},1e3)})}),
setname.clear()):setname==setrightbull&&(setname.forEach(function(el){var posiry=getRandomArbitrary(390,420),posirx=getRandomArbitrary(350,420);el.animate({cx:posirx,cy:posiry},1500)}),setname.clear()),courbureR.toFront(),courbureL.toFront(),tubGG.toFront(),tubGD.toFront(),tubDG.toFront(),tubDD.toFront(),degoulineur.toFront(),borderright.toFront(),degoulleft.toFront(),degoulcenter.toFront(),degoulright.toFront(),splizz.animate({"stroke-opacity":0,"fill-opacity":0},5e3,function(){"fluide"==activpuree?(pureefluide.animate({
path:"m 440.10168,-190.39885 c 0,0 19.11522,-3.88791 27.35333,-3.81871 7.32142,0.0615 19.57546,3.283 19.57546,3.283 0,0 -0.71005,208.516603 -0.26524,222.669609 0.53199,16.926848 -6.07243,24.435239 -6.07243,24.435239 l -48.04164,-7.079776 c 0,0 5.38567,-3.01645 6.83021,-13.315074 1.44453,-10.298624 0.62031,-226.174288 0.62031,-226.174288 z"},2e3),degoulineur.attr({"fill-opacity":1}),borderright.attr({"stroke-opacity":1}),degoulineur.animate({transform:"t0,-20",height:30,width:48},5e3,function(){borderright.hide(),degoulleft.animate({"fill-opacity":1},1e3,function(){degoulleft.animate({height:180},4e3)}),degoulcenter.animate({"fill-opacity":1},1e3,function(){
degoulcenter.animate({height:160},4e3)}),degoulright.animate({"fill-opacity":1},1e3,function(){degoulright.animate({height:130},3500)}),degoulineur.animate({height:180},8e3),waterpatch.animate({transform:"t0 -130"},4e3)})):"dense"==activpuree&&(pureefluide.animate({path:"m 440.10168,-190.39885 c 0,0 19.11522,-3.88791 27.35333,-3.81871 7.32142,0.0615 19.57546,3.283 19.57546,3.283 0,0 -0.71005,208.516603 -0.26524,222.669609 0.53199,16.926848 -6.07243,24.435239 -6.07243,24.435239 l -48.04164,-7.079776 c 0,0 5.38567,-3.01645 6.83021,-13.315074 1.44453,-10.298624 0.62031,-226.174288 0.62031,-226.174288 z"},2e3),extruder.attr({"fill-opacity":1}),borderright.attr({
"stroke-opacity":1}),extruder.animate({transform:"t0,-100"},5e3),borderright.toFront()),waterpatch.animate({transform:"t0 -130"},4e3)})}function boucheur(){setbouchon.forEach(function(e){e.show()}),ouvertG.toFront(),bouchoncache.show(),bouchoncache.toFront()}function videjarre(typep){var jarre;if("dense"==typep)setjarre=paper.set(),
...
setjarre.push(jarre),setjarre.animate({transform:"t-200, 10"},2e3,function(){setjarre.animate({transform:"t-200, 10 r-10"},2e3,function(){verso.show(),verso.toBack(),setjarre.toBack(),remplisseur(typep)})});else{var jarre;setjarre=paper.set(),
...
setjarre.push(jarre),setjarre.animate({transform:"t-200, 10"},2e3,function(){setjarre.animate({transform:"t-200, 10 r-10"},2e3,function(){verso.show(),verso.toBack(),setjarre.toBack(),remplisseur()})})}}function remplisseur(typep){var animwater;"dense"==typep?(pureefluide=paper.path("m 440.10168,-190.39885 c 0,0 16.25808,-3.3522 24.49619,-3.283 7.32142,0.0615 21.71831,3.283 21.71831,3.283 l 0,22.31247 0,29.42345 -46.46704,0.25254 0.0327,-29.31843 z").attr({id:"rect5036",parent:"layer1",opacity:"1",fill:"#e0d950","fill-opacity":"1",stroke:"#d2d8dd","stroke-width":"0","stroke-linecap":"round","stroke-linejoin":"round","stroke-miterlimit":"4",
"stroke-dasharray":"none","stroke-opacity":"1"}).transform("t-86.295739,364.87209").data("id","rect5036"),pureefluide.toBack(),animwater=Raphael.animation({
path:"m 304.85443,-134.28971 0,134.93009358 0,20.74325642 0.97053,18.188565 3.72936,13.641413 9.72085,15.644341 12.27975,11.57007 12.05743,7.7703 16.60944,7.36659 17.65763,3.85715 15.56283,1.945931 c 4.89286,-0.88213 10.96516,0.14585 16.86514,-0.93773 8.85809,-1.626811 13.94862,-1.683631 27.237,-7.158941 0,0 13.69711,-6.07533 19.71992,-10.43907 6.88822,-4.99078 18.37069,-17.712077 18.37069,-17.712077 0,0 6.69236,-13.326256 9.20555,-20.326849 3.14729,-8.766923 1.79478,-21.466934 1.79478,-21.466934 l -0.13637,-59.557602 -46.36946,0.133012 -0.2374,24.80493 -0.0646,21.41539 0.13321,12.57623 -0.94665,15.605928 -4.055,9.666637 -10.61726,11.975486 -14.48194,7.044743 -13.12242,1.829316 -16.34773,-3.047329 -11.23967,-4.54549 -9.32022,-9.2913 -6.13617,-10.213192 -1.22115,-16.047772 0,-41.231063 -0.51095,-118.478463 z"
},3e3),water.animate(animwater.delay(1150)),water.toBack(),pureefluide.animate({path:"m 440.10168,-190.39885 c 0,0 16.25808,-3.3522 24.49619,-3.283 7.32142,0.0615 21.71831,3.283 21.71831,3.283 0,0 1.16036,167.81321 0.44905,181.9553273 -0.7307,14.5277357 0.62238,41.9234507 0.62238,41.9234507 l -49.32419,5.25254 2.17556,-34.6755734 z"},2e3,function(){pureefluide.animate({
path:"m 440.10168,-190.39885 c 0,0 19.11522,-3.88791 27.35333,-3.81871 7.32142,0.0615 19.57546,3.283 19.57546,3.283 0,0 -0.71005,208.516603 -0.26524,222.669609 0.53199,16.926848 -6.07243,24.435239 -6.07243,24.435239 l -48.04164,-7.079776 c 0,0 5.38567,-3.01645 6.83021,-13.315074 1.44453,-10.298624 0.62031,-226.174288 0.62031,-226.174288 z"},1e3,function(){pureefluide.animate({
path:"m 440.10168,-190.39885 c 0,0 19.11522,-3.88791 27.35333,-3.81871 7.32142,0.0615 19.57546,3.283 19.57546,3.283 0,0 -0.96655,208.514867 -0.58091,222.669609 0.78453,28.79614 -23.49756,46.72173 -23.49756,46.72173 L 430.56772,53.131122 c 0,0 7.46911,-7.05706 8.91365,-17.355684 1.44453,-10.298624 0.62031,-226.174288 0.62031,-226.174288 z"},1e3,function(){hidejarre(),btcachetset.forEach(function(e){e.show()}),consigne.hide(),consigne2.show()})})})):(pureefluide=paper.path("m 440.10168,-190.39885 c 0,0 16.25808,-3.3522 24.49619,-3.283 7.32142,0.0615 21.71831,3.283 21.71831,3.283 l 0,22.31247 0,29.42345 -46.46704,0.25254 0.0327,-29.31843 z").attr({
id:"rect5036",parent:"layer1",opacity:"1",fill:"#e0d950","fill-opacity":"1",stroke:"#d2d8dd","stroke-width":"0","stroke-linecap":"round","stroke-linejoin":"round","stroke-miterlimit":"4","stroke-dasharray":"none","stroke-opacity":"1"}).transform("t-86.295739,364.87209").data("id","rect5036"),pureefluide.toBack(),animwater=Raphael.animation({
path:"m 304.85443,-134.28971 0,134.93009358 0,20.74325642 0.97053,18.188565 3.72936,13.641413 9.72085,15.644341 12.27975,11.57007 12.05743,7.7703 16.60944,7.36659 17.65763,3.85715 15.56283,1.945931 c 4.89286,-0.88213 10.96516,0.14585 16.86514,-0.93773 8.85809,-1.626811 13.94862,-1.683631 27.237,-7.158941 0,0 13.69711,-6.07533 19.71992,-10.43907 6.88822,-4.99078 18.37069,-17.712077 18.37069,-17.712077 0,0 6.69236,-13.326256 9.20555,-20.326849 3.14729,-8.766923 1.79478,-21.466934 1.79478,-21.466934 l -0.13637,-59.557602 -46.36946,0.133012 -0.2374,24.80493 -0.0646,21.41539 0.13321,12.57623 -0.94665,15.605928 -4.055,9.666637 -10.61726,11.975486 -14.48194,7.044743 -13.12242,1.829316 -16.34773,-3.047329 -11.23967,-4.54549 -9.32022,-9.2913 -6.13617,-10.213192 -1.22115,-16.047772 0,-41.231063 -0.51095,-118.478463 z"
},3e3),water.animate(animwater.delay(1150)),water.toBack(),pureefluide.animate({path:"m 440.10168,-190.39885 c 0,0 16.25808,-3.3522 24.49619,-3.283 7.32142,0.0615 21.71831,3.283 21.71831,3.283 0,0 1.16036,167.81321 0.44905,181.9553273 -0.7307,14.5277357 0.62238,41.9234507 0.62238,41.9234507 l -49.32419,5.25254 2.17556,-34.6755734 z"},2e3,"linear",function(){pureefluide.animate({
path:"m 440.10168,-190.39885 c 0,0 19.11522,-3.88791 27.35333,-3.81871 7.32142,0.0615 19.57546,3.283 19.57546,3.283 0,0 -0.71005,208.516603 -0.26524,222.669609 0.53199,16.926848 -6.07243,24.435239 -6.07243,24.435239 l -48.04164,-7.079776 c 0,0 5.38567,-3.01645 6.83021,-13.315074 1.44453,-10.298624 0.62031,-226.174288 0.62031,-226.174288 z"},1e3,function(){pureefluide.animate({
path:"m 440.10168,-190.39885 c 0,0 19.11522,-3.88791 27.35333,-3.81871 7.32142,0.0615 19.57546,3.283 19.57546,3.283 0,0 -0.96655,208.514867 -0.58091,222.669609 0.78453,28.79614 -23.49756,46.72173 -23.49756,46.72173 L 430.56772,53.131122 c 0,0 7.46911,-7.05706 8.91365,-17.355684 1.44453,-10.298624 0.62031,-226.174288 0.62031,-226.174288 z"},1e3,function(){hidejarre(),btcachetset.forEach(function(e){e.show()}),consigne.hide(),consigne2.show()})})}))}function hidejarre(){verso.hide(),setjarre.animate({transform:"r30"},2e3,function(){this.hide()})}function rzero(){extruder.remove(),extruder=paper.rect(354,180,46,200,5).attr({stroke:"none",fill:"#e0d950",
"fill-opacity":0}),btzeroset.forEach(function(e){e.hide()}),bouchoncache.hide(),setbouchon.forEach(function(e){e.hide()}),splizz.remove(),cachet.hide(),bullecollector.forEach(function(e){e.stop()}),bullecollector.remove(),degoulleft.remove(),degoulcenter.remove(),degoulright.remove(),degoulleft=paper.rect(349,170,10,5,15).attr({fill:"#e2dc5f",stroke:"none","fill-opacity":0}).stop(),degoulcenter=paper.rect(363,170,20,5,15).attr({fill:"#e2dc5f",stroke:"none","fill-opacity":0}).stop(),degoulright=paper.rect(395,170,10,5,15).attr({fill:"#e2dc5f",stroke:"none","fill-opacity":0}).stop(),borderright.show(),borderright.toFront(),pureefluide.attr("fill-opacity",0),
water.remove(),
...
id:"path4854",parent:"layer1",fill:"#56afff","fill-opacity":"1","fill-rule":"evenodd",stroke:"none","stroke-width":"1","stroke-opacity":"1","stroke-width":"1","stroke-linecap":"butt","stroke-linejoin":"miter","stroke-opacity":"1"}).transform("t-86.295739,364.87209").data("id","path4854"),water.stop(),waterpatch.remove(),waterpatch=paper.rect(219,330,48,80).attr({fill:"#56afff",stroke:"none"}).toBack(),degoulineur.remove(),degoulineur=paper.rect(353,180,45,5,15).attr({stroke:"none",fill:"#e0d950","fill-opacity":0}),consigne.show(),choix.show(),btfluidset.forEach(function(e){e.show()}),btdenseset.forEach(function(e){e.show()})}
var expetube,paper,water,courbureL,courbureR,tubGD,tubDG,tubDD,tubGG,ouvertG,pureefluide,degoulineur,borderright,extruder,setjarre,clickpfluide,clickpcompact,clickcachet,clickreinit,setbouchon,bouchoncache,consigne,choix,btfluidset,btfluide,choixfluide,btdenseset,btdense,choixdense,consigne2,btcachet,cachet,btcachetset,btzeroset,btrmzero,rmzero,activpuree,splizz,degoulleft,degoulcenter,degoulright,waterpatch,setleftbull,setrightbull,bullecollector,bulletimer,buttontimer,bullor,verso,arraytimer=[];return expetube=_.uniqueId("expetube_"),$container.find(".expetube").attr("id",expetube),paper=Raphael(expetube,800,600),paper.rect(0,0,800,600),
water=paper.path("m 304.85443,-36.80999 0,37.45037358 0,20.74325642 0.97053,18.188565 3.72936,13.641413 9.72085,15.644341 12.27975,11.57007 12.05743,7.7703 16.60944,7.36659 17.65763,3.85715 15.56283,1.945931 c 4.89286,-0.88213 10.96516,0.14585 16.86514,-0.93773 8.85809,-1.626811 13.94862,-1.683631 27.237,-7.158941 0,0 13.69711,-6.07533 19.71992,-10.43907 6.88822,-4.99078 18.37069,-17.712077 18.37069,-17.712077 0,0 6.69236,-13.326256 9.20555,-20.326849 3.14729,-8.766923 1.79478,-21.466934 1.79478,-21.466934 l -0.13637,-59.557602 -46.36946,0.133012 -0.2374,24.80493 -0.0646,21.41539 0.13321,12.57623 -0.94665,15.605928 -4.055,9.666637 -10.61726,11.975486 -14.48194,7.044743 -13.12242,1.829316 -16.34773,-3.047329 -11.23967,-4.54549 -9.32022,-9.2913 -6.13617,-10.213192 -1.22115,-16.047772 0,-41.231063 -0.51095,-20.998746 z").attr({
id:"path4854",parent:"layer1",fill:"#56afff","fill-opacity":"1","fill-rule":"evenodd",stroke:"none","stroke-width":"1","stroke-opacity":"1","stroke-width":"1","stroke-linecap":"butt","stroke-linejoin":"miter","stroke-opacity":"1"}).transform("t-86.295739,364.87209").data("id","path4854"),courbureL=paper.path("M 439.61216,29.97044 A 43.559486,38.034184 0 0 1 417.88635,63.174381 43.559486,38.034184 0 0 1 374.09024,63.107698 43.559486,38.034184 0 0 1 352.49718,29.837801").attr({id:"path4780",parent:"layer1",opacity:"1",fill:"none","fill-opacity":"1",stroke:"#000000","stroke-width":"1.01","stroke-linecap":"round","stroke-linejoin":"round",
"stroke-miterlimit":"4","stroke-dasharray":"none","stroke-opacity":"1"}).transform("t-86.295739,364.87209").data("id","path4780").toFront(),courbureR=paper.path("M 487.09675,29.92162 A 91.045479,70.813156 0 0 1 441.68674,91.741915 91.045479,70.813156 0 0 1 350.14644,91.617648 91.045479,70.813156 0 0 1 305.01416,29.674441").attr({id:"path4782",parent:"layer1",opacity:"1",fill:"none","fill-opacity":"1",stroke:"#000000","stroke-width":"1.01","stroke-linecap":"round","stroke-linejoin":"round","stroke-miterlimit":"4","stroke-dasharray":"none","stroke-opacity":"1"}).transform("t-86.295739,364.87209").data("id","path4782").toFront(),
tubGD=paper.path("m 352.49447,32.558011 c 0,-5.058094 0,-222.555661 0,-222.555661 l 0,5.05809").attr({id:"path4784",parent:"layer1",fill:"none","fill-rule":"evenodd",stroke:"#000000","stroke-width":"1.01","stroke-linecap":"butt","stroke-linejoin":"miter","stroke-opacity":"1"}).transform("t-86.295739,364.87209").data("id","path4784"),tubDG=paper.path("m 439.53961,32.558011 c 0,-5.058094 0,-222.555661 0,-222.555661 l 0,5.05809").attr({id:"path4784-5",parent:"layer1",fill:"none","fill-rule":"evenodd",stroke:"#000000","stroke-width":"1.01","stroke-linecap":"butt","stroke-linejoin":"miter","stroke-opacity":"1"
}).transform("t-86.295739,364.87209").data("id","path47845"),tubDD=paper.path("m 486.87001,32.558011 c 0,-5.058094 0,-222.555661 0,-222.555661 l 0,5.05809").attr({id:"path4784-6",parent:"layer1",fill:"none","fill-rule":"evenodd",stroke:"#000000","stroke-width":"1.01","stroke-linecap":"butt","stroke-linejoin":"miter","stroke-opacity":"1"}).transform("t-86.295739,364.87209").data("id","path47846"),tubGG=paper.path("m 304.77903,32.558011 c 0,-5.058094 0,-222.555661 0,-222.555661 l 0,5.05809").attr({id:"path4784-6-2",parent:"layer1",fill:"none","fill-rule":"evenodd",stroke:"#000000","stroke-width":"1.01","stroke-linecap":"butt","stroke-linejoin":"miter",
"stroke-opacity":"1"}).transform("t-86.295739,364.87209").data("id","path478462"),ouvertG=paper.ellipse(328.61954,-189.19867,23.925554,4.6123991).attr({id:"path4835",parent:"layer1",opacity:"1",fill:"none","fill-opacity":"1",stroke:"#000000","stroke-width":"1.01","stroke-linecap":"round","stroke-linejoin":"round","stroke-miterlimit":"4","stroke-dasharray":"none","stroke-opacity":"1"}).transform("t-86.295739,364.87209").data("id","path4835"),paper.ellipse(463.30063,-188.73909,23.925554,4.6123991).attr({id:"path4835-2",parent:"layer1",opacity:"1",fill:"none","fill-opacity":"1",stroke:"#000000","stroke-width":"1.01","stroke-linecap":"round",
"stroke-linejoin":"round","stroke-miterlimit":"4","stroke-dasharray":"none","stroke-opacity":"1"}).transform("t-86.295739,364.87209").data("id","path48352"),
...
degoulineur=paper.rect(353,180,45,5,15).attr({stroke:"none",fill:"#e0d950","fill-opacity":0}),borderright=paper.path("m 400,175 a 23.665695,4.3979797 0 0 1 -23.15952,4.39697 23.665695,4.3979797 0 0 1 -24.15022,-4.20888").attr({"stroke-width":1}).toFront(),extruder=paper.rect(354,180,46,200,5).attr({stroke:"none",fill:"#e0d950","fill-opacity":0}),clickpfluide=0,clickpcompact=0,clickcachet=0,clickreinit=0,setbouchon=paper.set(),setbouchon.push(paper.ellipse(319.02319,-219.44574,30.800091,6.1481109).attr({id:"path4856",parent:"layer1",opacity:"1",fill:"#82919f","fill-opacity":"1",stroke:"none","stroke-width":"1","stroke-opacity":"1","stroke-width":"1",
"stroke-linecap":"round","stroke-linejoin":"round","stroke-miterlimit":"4","stroke-dasharray":"none","stroke-opacity":"1"}).transform("t-86.295739,364.87209 m1,0,-0.04472932,0.99899914,0,0").data("id","path4856"),paper.path("m 298.74788,-220.19915 9.23372,45.41187 41.33232,0 9.08757,-45.61304 z").attr({id:"path4858",parent:"layer1",fill:"#82919f","fill-opacity":"1","fill-rule":"evenodd",stroke:"#000000","stroke-width":"0","stroke-linecap":"butt","stroke-linejoin":"miter","stroke-miterlimit":"4","stroke-dasharray":"none","stroke-opacity":"1"
}).transform("t-86.295739,364.87209").data("id","path4858"),paper.path("m 300.11947,-217.09436 c -0.219,-1.45618 8.65352,-2.38467 25.63767,-3.46684 15.7513,-1.00362 31.32922,1.88101 31.64271,3.33699 -15.15104,-5.48551 -49.86088,-1.89976 -57.28038,0.12985 z").attr({id:"path4860",parent:"layer1",opacity:"1",fill:"none","fill-opacity":"1",stroke:"#c4dce0","stroke-width":"0.71","stroke-linecap":"round","stroke-linejoin":"round","stroke-miterlimit":"4","stroke-dasharray":"none","stroke-opacity":"1"}).transform("t-86.295739,364.87209").data("id","path4860")),setbouchon.forEach(function(e){e.hide()}),
bouchoncache=paper.path("m 304.47494,-192.15568 0.71022,3.53547 46.82955,-0.0282 0.62553,-2.76208 -21.46876,-6.7677 -18.57604,2.40644 z").attr({id:"path4863",parent:"layer1",fill:"#82919f","fill-opacity":"1","fill-rule":"evenodd",stroke:"#000000","stroke-width":"0","stroke-linecap":"butt","stroke-linejoin":"miter","stroke-miterlimit":"4","stroke-dasharray":"none","stroke-opacity":"1"}).transform("t-86.295739,364.87209").data("id","path4863").hide(),paper.rect(560,130,240,350).attr({fill:"pink","fill-opacity":.5}),consigne=paper.text(680,170,"Vous allez pouvoir ajouter \n de la purée de pomme de terre \n dans le tube en forme de U.").attr({
"text-anchor":"middle",stroke:"#545454","font-size":16}),choix=paper.text(680,240,"Choisissez la densité \n de la purée à verser : ").attr({"text-anchor":"middle",stroke:"#545454","font-size":16}),btfluidset=paper.set(),btfluide=paper.rect(610,300,140,40,5).attr({fill:"lightgrey"}),choixfluide=paper.text(680,320,"Purée fluide ").attr({"text-anchor":"middle",stroke:"#545454","font-size":16,cursor:"pointer"}),btfluidset.push(btfluide),btfluidset.push(choixfluide),btfluidset.mouseover(function(event){this.attr({"fill-opacity":.3,"stroke-opacity":.6})}),btfluidset.mouseout(function(event){this.attr({"fill-opacity":1,"stroke-opacity":1})}),btdenseset=paper.set(),
btdense=paper.rect(610,380,140,40,5).attr({fill:"lightgrey"}),choixdense=paper.text(680,400,"Purée compacte").attr({"text-anchor":"middle",stroke:"#545454","font-size":16,cursor:"pointer"}),btdenseset.push(btdense),btdenseset.push(choixdense),btdenseset.mouseover(function(event){this.attr({"fill-opacity":.3,"stroke-opacity":.6})}),btdenseset.mouseout(function(event){this.attr({"fill-opacity":1,"stroke-opacity":1})}),paper.rect(590,232,175,40,5).attr({fill:"lightgrey"}).hide(),consigne2=paper.text(680,170,"Vous allez maintenant ajouter \n un cachet effervescent \n à l'eau présente dans le tube.").attr({"text-anchor":"middle",stroke:"#545454","font-size":16
}).hide(),btcachet=paper.rect(580,245,200,50,5).attr({fill:"lightgrey"}).hide(),cachet=paper.text(680,270,"Introduire le cachet \n effervescent et boucher !").attr({"text-anchor":"middle",stroke:"#545454","font-size":16,cursor:"pointer"}).hide(),btcachetset=paper.set(),btcachetset.push(btcachet),btcachetset.push(cachet),btzeroset=paper.set(),btrmzero=paper.rect(580,245,200,50,5).hide(),rmzero=paper.text(680,270,"Rétablir les conditions \n initiales").attr({"text-anchor":"middle",stroke:"#545454","font-size":16,cursor:"pointer"}).hide(),btzeroset.push(btrmzero),btzeroset.push(rmzero),degoulleft=paper.rect(349,170,10,5,15).attr({fill:"#e2dc5f",stroke:"none",
"fill-opacity":0}),degoulcenter=paper.rect(363,170,20,5,15).attr({fill:"#e0e053",stroke:"none","fill-opacity":0}),degoulright=paper.rect(395,170,10,5,15).attr({fill:"#e2dc5f",stroke:"none","fill-opacity":0}),waterpatch=paper.rect(219,330,48,80).attr({fill:"#56afff",stroke:"none"}).toBack(),btfluidset.click(function(event){activpuree="fluide",videjarre(),choix.hide(),btfluidset.forEach(function(e){e.hide()}),btdenseset.forEach(function(e){e.hide()}),clickpfluide+=1,$container.find(".clickpfluide").html(clickpfluide)}),btdenseset.click(function(event){activpuree="dense",videjarre(activpuree),choix.hide(),btfluidset.forEach(function(e){e.hide()}),
btdenseset.forEach(function(e){e.hide()}),clickpcompact+=1,$container.find(".clickpcompact").html(clickpcompact)}),setleftbull=paper.set(),setrightbull=paper.set(),bullecollector=paper.set(),btcachetset.click(function(event){dropcachet(),consigne2.hide(),cachet.hide(),btcachet.hide(),clickcachet+=1,$container.find(".clickcachet").html(clickcachet)}),verso=paper.path("m 360,175 16.78572,-70 c 0,0 15,30 17,42.07812 2.79781,13.13813 5.17915,42.5639 5.17915,42.5639 l -3.57142,3.93684 z").attr({stroke:"none",fill:"#e0d950"}).hide(),btzeroset.click(function(event){clearTimeout(bulletimer),clearTimeout(buttontimer),bullor.stop(),degoulineur.stop(),
degoulleft.stop(),degoulcenter.stop(),degoulright.stop(),water.stop(),pureefluide.stop(),waterpatch.stop(),extruder.stop(),rzero(),clickreinit+=1,$container.find(".clickreinit").html(clickreinit)}),arraytimer}return{render:function(id,container,config,assetManager){renderChoices(id,$(container),config)}}}),function(){function n(n,t,e){e=(e||0)-1;for(var r=n?n.length:0;++e<r;)if(n[e]===t)return e;return-1}function t(t,e){var r=typeof e;if(t=t.l,"boolean"==r||null==e)return t[e]?0:-1;"number"!=r&&"string"!=r&&(r="object");var u="number"==r?e:b+e;return t=(t=t[r])&&t[u],"object"==r?t&&-1<n(t,e)?0:-1:t?0:-1}function e(n){var t=this.l,e=typeof n
...
define("volcanismePCI/interaction/runtime/js/volcanismeInteraction",["qtiCustomInteractionContext","taoQtiItem/portableLib/jquery_2_1_1","volcanismePCI/interaction/runtime/js/renderer","taoQtiItem/portableLib/OAT/util/event"],function(qtiCustomInteractionContext,$,renderer,event){"use strict";var volcanismeInteraction={typeIdentifier:"volcanismePCI",getInstance:function(dom,config,state){var response=config.boundTo;this.initialize(Object.getOwnPropertyNames(response).pop(),dom,config.properties,config.assetManager),this.setSerializedState(state),"function"==typeof config.onready&&config.onready(this,this.getState())},getState:function(){
return this.getSerializedState()},oncompleted:function(){this.destroy()},getResponse:function(){var $container=$(this.dom);return{base:{string:'{"exp_pfluide" : '+$container.find(".clickpfluide").text()+',"exp_pcompacte":'+$container.find(".clickpcompact").text()+',"animCachet":'+$container.find(".clickcachet").text()+',"retourInit":'+$container.find(".clickreinit").text()+"}"}}},destroy:function(){$(this.dom).off().empty()},getTypeIdentifier:function(){return"volcanismePCI"},initialize:function(id,dom,config,assetManager){var self=this;event.addEventMgr(this),this.dom=dom,this.config=config||{},renderer.render(id,this.dom,this.config,assetManager),
this.on("levelchange",function(level){self.config.level=level,renderer.renderChoices(id,self.dom,self.config)})},setResponse:function(response){var $container=$(this.dom),value=response&&response.base?parseInt(response.base.integer):-1;$container.find('input[value="'+value+'"]').prop("checked",!0)},resetResponse:function(){$(this.dom).find("input").prop("checked",!1)},setSerializedState:function(state){state&&state.response&&this.setResponse(state.response)},getSerializedState:function(){return{response:this.getResponse()}}};return qtiCustomInteractionContext.register(volcanismeInteraction),volcanismeInteraction}),function(c){
var d=document,a="appendChild",i="styleSheet",s=d.createElement("style");s.type="text/css",d.getElementsByTagName("head")[0][a](s),s[i]?s[i].cssText=c:s[a](d.createTextNode(c))}("\n.qti-customInteraction .volcanisme{\n    width:100%;\n\n}\n\n.qti-customInteraction .volcanisme .hiddendiv{\n\tdisplay: none;\n}"),define(["volcanismePCI/interaction/runtime/js/volcanismeInteraction"],function(IMSPCI){return IMSPCI});
//# sourceMappingURL=volcanismeInteraction.min.js.map